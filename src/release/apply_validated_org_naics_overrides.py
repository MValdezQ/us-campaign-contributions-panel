...
OVERRIDE_PATH = VALIDATION_DIR / "org_naics_validation_overrides_v1001_production_safe.csv"
OUT_PATH = VALIDATION_DIR / "org_naics_assignment_validated_v1001_preview.csv"
...
def apply_overrides(assignments: pd.DataFrame, overrides: pd.DataFrame) -> pd.DataFrame:
    ...
    base_columns = assignments.columns.tolist()
